...
var reactIs = __webpack_require__(141);
...
var callWithSafeIterationClosing = __webpack_require__(89);
...
var l=__webpack_require__(74),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.forward_ref"):60112,y=n?Symbol.for("react.suspense"):60113,z=n?Symbol.for("react.memo"):60115,A=n?Symbol.for("react.lazy"):
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(74),r=__webpack_require__(110);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var collection = __webpack_require__(135);
...
var es_array_iterator = __webpack_require__(19);
...
var es_object_get_prototype_of = __webpack_require__(68);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(16);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.reflect.construct.js
var es_reflect_construct = __webpack_require__(69);
...
var es_array_reduce = __webpack_require__(20);
...
var es_array_for_each = __webpack_require__(131);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.splice.js
var es_array_splice = __webpack_require__(132);
...
var es_map = __webpack_require__(134);
...
function _possibleConstructorReturn(self, call) { if (call && (error_typeof(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized(self); }
...
var hoistNonReactStatics = hoist_non_react_statics_cjs_default.a || hoist_non_react_statics_cjs;
...
var IntlConsumer = IntlContext.Consumer,
    injectIntl_IntlProvider = IntlContext.Provider;
var Provider = injectIntl_IntlProvider;
...
function message_formatMessage(_ref, state) {
...
var objects = __webpack_require__(29);
...
function message_toConsumableArray(arr) { return message_arrayWithoutHoles(arr) || message_iterableToArray(arr) || message_unsupportedIterableToArray(arr) || message_nonIterableSpread(); }

function message_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
...
function message_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function message_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return message_arrayLikeToArray(arr); }
...
function message_createSuper(Derived) { return function () { var Super = message_getPrototypeOf(Derived), result; if (message_isNativeReflectConstruct()) { var NewTarget = message_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return message_possibleConstructorReturn(this, result); }; }
...
var shallowEquals = objects_default.a || objects;

function defaultFormatMessage(descriptor, values) {
  if (false) {}

  return message_formatMessage(Object.assign(Object.assign({}, DEFAULT_INTL_CONFIG), {
    locale: 'en'
  }), createFormatters(), descriptor, values);
}

var message_FormattedMessage = /*#__PURE__*/function (_React$Component) {
  message_inherits(FormattedMessage, _React$Component);

  var _super = message_createSuper(FormattedMessage);

  function FormattedMessage() {
    message_classCallCheck(this, FormattedMessage);
    ...
    value: function render() {
      ...
      return react["createElement"](Context.Consumer, null, function (intl) {
        ...
        if (typeof children === 'function') {
          return children.apply(void 0, message_toConsumableArray(nodes));
        }

        if (Component) {
          // Needs to use `createElement()` instead of JSX, otherwise React will
          // warn about a missing `key` prop with rich-text message formatting.
          return react["createElement"].apply(react, [Component, null].concat(message_toConsumableArray(nodes)));
        }
...
message_FormattedMessage.displayName = 'FormattedMessage';
message_FormattedMessage.defaultProps = {
  values: {}
};
/* harmony default export */ var components_message = (message_FormattedMessage);
...
function provider_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { provider_typeof = function _typeof(obj) { return typeof obj; }; } else { provider_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return provider_typeof(obj); }
...
function provider_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function provider_createClass(Constructor, protoProps, staticProps) { if (protoProps) provider_defineProperties(Constructor.prototype, protoProps); if (staticProps) provider_defineProperties(Constructor, staticProps); return Constructor; }

function provider_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) provider_setPrototypeOf(subClass, superClass); }

function provider_setPrototypeOf(o, p) { provider_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return provider_setPrototypeOf(o, p); }

function provider_createSuper(Derived) { return function () { var Super = provider_getPrototypeOf(Derived), result; if (provider_isNativeReflectConstruct()) { var NewTarget = provider_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return provider_possibleConstructorReturn(this, result); }; }

function provider_possibleConstructorReturn(self, call) { if (call && (provider_typeof(call) === "object" || typeof call === "function")) { return call; } return provider_assertThisInitialized(self); }
...
function provider_getPrototypeOf(o) { provider_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return provider_getPrototypeOf(o); }
...
var provider_shallowEquals = objects_default.a || objects;
...
var provider_IntlProvider = /*#__PURE__*/function (_React$PureComponent) {
  provider_inherits(IntlProvider, _React$PureComponent);

  var _super = provider_createSuper(IntlProvider);

  function IntlProvider() {
    var _this;

    provider_classCallCheck(this, IntlProvider);
  ...
  provider_createClass(IntlProvider, [{
    key: "render",
    value: function render() {
    ...
    value: function getDerivedStateFromProps(props, _ref) {
      ...
      if (!provider_shallowEquals(prevConfig, config)) {
        return {
...
function App() {
  return /*#__PURE__*/react_default.a.createElement("p", null, /*#__PURE__*/react_default.a.createElement(components_message, {
    id: "welcome",
    defaultMessage: "Hello World!"
  }));
}

react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(provider_IntlProvider, {
  locale: "en"
}, /*#__PURE__*/react_default.a.createElement(App, null)), document.getElementById("container"));
